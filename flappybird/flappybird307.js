...
function spawnPipePair() {
        ...
        topPipe = new Sprite(bird.x + 400, random(350, height - 350) - random(50,60) / 2 - 200, 52, 320, 'static');
        bottomPipe = new Sprite(bird.x + 400, random(350, height - 350) + random(50,60) / 2 + 200, 52, 320, 'static');
